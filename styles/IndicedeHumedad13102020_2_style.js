...
var style_IndicedeHumedad13102020_2 = function(feature, resolution){
    ...
    if (value >= -0.153386 && value <= -0.072431) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.072431 && value <= 0.008525) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.008525 && value <= 0.089480) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.089480 && value <= 0.170435) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.170435 && value <= 0.251391) {
            style = [ new ol.style.Style({
