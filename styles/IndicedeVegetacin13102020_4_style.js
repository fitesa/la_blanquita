...
var style_IndicedeVegetacin13102020_4 = function(feature, resolution){
    ...
    if (value >= 0.132408 && value <= 0.248665) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.248665 && value <= 0.364923) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.364923 && value <= 0.481181) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.481181 && value <= 0.597439) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.597439 && value <= 0.713697) {
            style = [ new ol.style.Style({
