...
var style_EvolucinIndicedeVegetacin29081310_3 = function(feature, resolution){
    ...
    if (value >= -0.098745 && value <= 0.007734) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.007734 && value <= 0.114212) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.114212 && value <= 0.220690) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.220690 && value <= 0.327168) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.327168 && value <= 0.433647) {
            style = [ new ol.style.Style({
